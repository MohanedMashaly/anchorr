...
Anchor’s archtiecture is intentionally straightforward. The App is divided into two main modules/components 
  1. **Atlassian Plugin** :
     The component responsible for Anchor's interaction with Atlassian and Jira. It is developed using Atlassian Forge, JavaScript, and Forge UI, providing a seamless experience directly inside Jira.
